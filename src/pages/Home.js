...
export default function Home() {
  return (
    <div className="relative pt-10 max-md:pt-4">
      <img
        className="absolute top-0 left-0 w-full h-[1000px] object-cover max-lg:h-[850px] max-md:h-[650px] z-[-1] object-bottom"
      ...
      <div className="container z-0 max-md:overflow-hidden">
        ...
        <div className="mt-20 max-md:mt-14 flex flex-col text-center items-center justify-center m-auto max-w-[1100px] w-full px-2">
          ...
          <div className="text-[56px] max-md:text-[30px] leading-none mt-5">
            Unleash the Power of Hanuman
          </div>
          <div className="font-jaka leading-[35px] max-md:text-[16px] max-md:leading-[24px] font-medium text-[20px] max-w-[800px] mt-5 max-md:mt-3">
            Hanuman Token ($HNMN) is a community-driven memecoin celebrating the
            spirit of courage, devotion, and strength inspired by Lord Hanuman.
            $HNMN is the perfect mix of fun, culture, and limitless potential.
            Join the legion and let’s take $HNMN to the moon—Jai Hanuman!
          </div>
        </div>

        <img
          className="object-contain mx-auto mt-10 md:w-[200px] w-[150px] lg:w-[400px] max-md:mt-6"
          src={HanumanImage}
          alt="Hanuman"
        />
        ...
        {/* About Section */}
        <section
          className="flex items-center justify-between mt-60 max-md:mt-14 max-md:text-center max-md:flex-col-reverse max-md:justify-center"
          id="about"
        >
          <div>
            <div className="flex items-center w-full max-md:justify-center">
              <Title>About</Title>
              <div className="text-primary uppercase text-[40px] max-md:text-[32px] ml-4">
                Hanuman
              </div>
            </div>
            <div className="text-[16px] max-md:text-[14px] leading-[35px] max-md:leading-[24px] font-jaka w-full max-w-[560px]">
              Hanuman Token ($HNMN) is a community-driven memecoin celebrating
              the spirit of courage, devotion, and strength inspired by Lord
              Hanuman. $HNMN is the perfect mix of fun, culture, and limitless
              potential. Join the legion and let’s take $HNMN to the moon—Jai
              Hanuman!
            </div>
            <div className="max-md:m-auto max-md:w-fit">
              <div className="flex items-center gap-3 mt-8">
                <img className="" src={CheckIcon} alt="check" />
                <div className="font-jaka font-semibold text-[16px]">
                  Community-Driven
                </div>
              </div>
            ...
            <Button className="mt-10 max-md:m-auto max-md:mt-8">
              Buy Hanuman
            </Button>
          </div>
          <div className="relative">
            <img
              className="max-md:mt-16 w-[80%] md:w-[600px] max-md:m-auto"
              src={HanumanImage}
              alt="Hanuman"
            />
        ...
        <section className="mt-60 max-md:mt-32 max-md:text-center">
          ...
          <div className="flex items-center justify-center gap-10 mt-10 max-lg:flex-col">
            ...
            <div className="max-w-[335px] w-full max-md:max-w-none">
              <div className="m-auto py-[6px] px-[10px] w-fit rounded-[6px] leading-none text-black bg-white text-[24px] mb-10">
                02
              </div>
              <SmallCard
        ...
        {/* Tokenomics Section */}
        <section
          className="pt-40 mt-40 max-md:!bg-cover max-md:!bg-center -ml-5 max-md:mt-32 max-md:pt-30 max-md:text-center max-md:!w-[calc(100%+35px)]"
          style={{
          ...
          id="tokenomics"
        >
          <Title className="text-center">Tokenomics</Title>
        ...
        <section className="relative mt-96 max-md:mt-48">
          ...
          <img
            className="absolute bottom-10 right-10 md:w-[200px] w-[90px] left-1/2 -translate-x-1/2 -top-28"
            src={HanumanImage}
            alt="Hanuman"
          />
        </section>
      ...
      <div className="bg-[#91268E10] text-white mt-24">
        <div
          className="flex items-center justify-between px-16 py-8 max-md:flex-col max-md:justify-center"
          style={{
            boxShadow: `0px 10px 0 #EC52E7`,
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="uppercase text-[24px] max-md:text-[18px]">
              Hanuman
            </div>
          </div>
